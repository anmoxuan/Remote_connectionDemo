...
namespace Vnc.Viewer
{
  ...
  internal class ViewOpts
  {
    ...
    private const string Force8BitName = "8位";
    private const string Force16BitName = "16位";
    private const string UnspecName = "系统自适应";
    ...
    internal PixelSize PixelSize = PixelSize.Force16Bit;
    ...
    internal CliScaling CliScaling = CliScaling.Auto;  //haykin 2015-8-19
