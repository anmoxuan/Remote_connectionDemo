...
namespace Vnc.Viewer
{
    ...
    internal abstract class SessDlg : Form
    {
        ...
        private const UInt16 VncPort = 12005;//5900;//
        ...
        internal SessDlg(ViewOpts viewOpts)
            : base()
        {
        ...
        public void Ok(string ip, string port, bool readOnly)
        {
        ...
        protected bool ValidateHostPort()
        {
            ...
            if (indexOfColon < 0) // Colon not found.
            {
                ...
                {
                    MessageBox.Show(App.GetStr("Please specify the RDP server to connect to!"),
                                    Text,
                                    MessageBoxButtons.OK,
                                    MessageBoxIcon.Exclamation,
                                    MessageBoxDefaultButton.Button1);
        ...
        {
            passwd = "bs@rms15";//passwdBox.Text;
        }
        ...
        protected virtual void GetOptions()
        {
            ...
            viewOpts.ServScaling = ServScaling.Default;//(ServScaling)servScalingBox.SelectedIndex;
            //viewOpts.ViewOnly = viewOnlyBox.Checked;
            viewOpts.ViewOnly = this.readOnly;
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            MinimizeBox = false;
            MaximizeBox = false;
            Text = App.GetStr("New RDP Connection");
            Menu = new MainMenu();
            ...
            pixelSizeLbl.Text = App.GetStr("像素尺寸:");
            pixelSizeBox.DropDownStyle = ComboBoxStyle.DropDownList;
            pixelSizeBox.Items.Add(App.GetStr("系统自适应"));
            pixelSizeBox.Items.Add(App.GetStr("8位"));
            pixelSizeBox.Items.Add(App.GetStr("16位"));
