...
namespace Vnc.Viewer
{
    internal abstract class ViewFullCf : View
    {
        ...
        private void SaveConnOpts(bool savePwd)
        {
            ...
            dlg.Filter = App.GetStr("RDP files (*.vncxml)|*.vncxml|All files (*.*)|*.*");
        ...
        internal ViewFullCf(Conn conn, ConnOpts connOpts, UInt16 width, UInt16 height)
            : base(conn, connOpts, width, height)
        {
            this.Icon = ((System.Drawing.Icon)(global::VNCClientTest.Properties.Resources.Õ–≈Ã‘⁄œﬂ));
